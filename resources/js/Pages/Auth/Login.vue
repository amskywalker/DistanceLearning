<template>
    <div class="h-screen w-screen grid grid-cols-2">
        <div class="image h-100 flex justify-center items-center">
            <img src="img/student.svg" alt="student image">
        </div>
        <div class="form h-100 flex flex-col justify-center items-center">
            <div class="flex mb-16">
                <img src="img/IziHomework.svg" alt="Logo">
            </div>
            <form @submit.prevent="submit" class="h-2/4 w-2/4">
                ...
                <div class="form-group flex flex-col justify-between mb-2">
                    <label for="password" class="mb-2 text-gray-400 font-bold">Password</label>
                    <input
                        class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                        id="password"
